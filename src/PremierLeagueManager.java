	...
	public void addPlayedMatchDetails(String date, String stadium, String team, int teamGoals, int otherTeamGoals, String teamNum) {
		...
		for (SportsClub sportsClub:premierLeagueClubsList){
			if (sportsClub.getNameOfTheClub().contains(team)){
				...
				clubUpdate = new FootballClub(premierLeagueClubsList.indexOf(sportsClub),team,sportsClub.getLocation(),sportsClub.getNumOfMembers(),date,match,won,drawn,lost,goalsScore,goalsReceived,goalsDifference,points);
		...
		if (teamNum.equalsIgnoreCase("Team B")){
